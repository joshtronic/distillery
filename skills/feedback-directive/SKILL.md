---
name: feedback-directive
description: Player-feedback triage directive: DROP/FILE decision contract over untrusted CSV rows
consumers: igor-surface
source: bin/lib/feedback-directive.md
